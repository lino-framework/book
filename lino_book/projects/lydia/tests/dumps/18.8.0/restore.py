...
def create_users_user(id, email, language, modified, created, start_date, end_date, access_class, event_type_id, password, last_login, username, user_type, initials, first_name, last_name, remarks, time_zone, team_id, partner_id):
...
def create_courses_enrolment(id, start_date, end_date, printed_by_id, user_id, course_area, course_id, pupil_id, request_date, state, places, option_id, remark, confirmation_details, guest_role_id, fee_id):
#    if course_area: course_area = settings.SITE.models.courses.CourseAreas.get_by_value(course_area)
...
def create_notes_note(id, project_id, build_time, build_method, user_id, owner_type_id, owner_id, company_id, contact_person_id, contact_role_id, date, time, type_id, event_type_id, subject, body, language):
#    if build_method: build_method = settings.SITE.models.printing.BuildMethods.get_by_value(build_method)
    owner_type_id = new_content_type_id(owner_type_id)
    kw = dict()
    kw.update(id=id)
