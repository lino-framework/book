...
loader.save(create_ledger_journal(4,u'PMO',4,['Bestbank Payment Orders', 'Bestbank Payment Orders', 'Bestbank Payment Orders'],None,u'','B','finan.PaymentOrdersByJournal','40',True,True,False,3,100,['', '', ''],False,True,True,31))
