...
loader.save(create_excerpts_excerpttype(9,['Sales invoice', 'Sales invoice', 'Sales invoice'],None,u'',False,u'',True,u'',u'',sales_VatProductInvoice,True,False,True,True,None))
