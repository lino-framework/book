...
ns.setup_from_tasks(
    ...
    demo_projects=[
        ...
        'lino_book.projects.lets1.settings',
        ...
        'lino_book.projects.gfktest.settings.demo',
        'lino_book.projects.actions.settings',
        'lino_book.projects.actors.settings',
        'lino_book.projects.tables.settings',
        'lino_book.projects.vtables.settings',
        'lino_book.projects.integer_pk.settings',
        'lino_book.projects.float2decimal.settings',
        'lino_book.projects.myroles.settings',
        'lino_book.projects.mldbc.settings',
        'lino_book.projects.human.settings',
        'lino_book.projects.de_BE.settings',
        'lino_book.projects.auto_create.settings',
        'lino_book.projects.addrloc.settings',
        
        # 'lino_book.projects.diamond.settings',
        # 'lino_book.projects.diamond2.settings',
        # 'lino_book.projects.polls.settings',
        # 'lino_book.projects.polls2.settings',
        # 'lino_book.projects.sendchanges.settings',
        # 'lino_book.projects.pisa.settings',
    ])
