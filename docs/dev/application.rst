...
An application, for Lino, is a *standalone piece of software* which is
...
<https://docs.djangoproject.com/en/3.1/ref/contrib/contenttypes/>`_
...
.. As a compromise, we suggest to just change the documentation.  We
   ...
   <https://docs.djangoproject.com/en/3.1/ref/applications/>`_,
