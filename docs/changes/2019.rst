...
Fixed a bug in :mod:`lino_xl.lib.phones` :  The datachecker failed with
MultipleObjectsReturned when a same partner had multiple contact detail entries
marked as primary. Now it creates a message  "Multiple primary items for <type>"
in that case.
