...
Fix an issue when using the recently released version 3.1 of Django: we must now
import :class:`FieldDoesNotExist` from :mod:`django.core.exceptions` (no longer
from :mod:`django.db.models.fields`).
